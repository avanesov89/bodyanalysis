...
Личный web-журнал питания, показателей тела, активности, замеров, сна и заметок.
...
- сон: часы сна, качество;
- заметки: настроение, стресс;
- настройки: профиль для анализа, режим хранилища и выгрузка ZIP-архива с JSON и MD-промтом после 14 заполненных дней по выбранному разделу или всем данным.
